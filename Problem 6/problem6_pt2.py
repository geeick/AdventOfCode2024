    ...
    while 0 < posx < rows -1 and 0 < posy < cols - 1:
        if dir == "UP":
            if board[posx-1][posy] != '#':
                ...
                board[posx][posy] = 'X'
                posx -= 1
                if is_loop(file_path, posx, posy, "UP", seen) and (posx - 1, posy) not in loops:
                    count += 1
                    loops.add((posx -1, posy))
                seen.add((posx, posy, dir))
            elif board[posx-1][posy] == '#':
                dir = 'RIGHT'
                if is_loop(file_path, posx, posy, "RIGHT", seen) and (posx, posy + 1) not in loops:
                    count += 1
            ...
            if board[posx][posy+1] != '#':
                ...
                dir = 'DOWN'
                if is_loop(file_path, posx, posy, "DOWN", seen) and (posx + 1, posy) not in loops:
                    count += 1
                    loops.add((posx +1, posy))
            ...
            if board[posx+1][posy] != '#':
                ...
                dir = 'LEFT' 
                if is_loop(file_path, posx, posy, "LEFT", seen) and (posx, posy - 1) not in loops:
                    count += 1
                    loops.add((posx, posy -1))
...
initialX, initialY = initial_pos(file_path)
